...
public final class FuncionarioPC extends JPanel implements GUI {
	...
	public void reiniciarGUI() {
		...
		if (!MainCT.getFuncionarioFC().isShowing()
				&& MainCT.getFuncionarioFC().getFuncionarioHandle().getFuncionario() != null) {
			centroCusto = MainCT.getFuncionarioFC().getFuncionarioHandle().getFuncionario()
					.getCentroCusto();
