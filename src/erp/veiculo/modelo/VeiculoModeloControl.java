...
final class VeiculoModeloControl {
	...
	public class PesquisaRegistro implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getVeiculoModeloFp());
	...
	public VeiculoModeloFc getVeiculoModeloFc() {
		return MainControl.getVeiculoModeloFc();
	}

	public VeiculoModeloFp getVeiculoModeloFp() {
		return MainControl.getVeiculoModeloFp();
	}

	public VeiculoModeloPc getVeiculoModeloPc() {
		return MainControl.getVeiculoModeloFc().getVeiculoModeloPc();
	}

	public VeiculoModeloPp getVeiculoModeloPp() {
		return MainControl.getVeiculoModeloFp().getVeiculoModeloPp();
	}
