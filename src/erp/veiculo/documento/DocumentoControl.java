...
final class DocumentoControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getDocumentoFp());
	...
	public DocumentoFc getDocumentoFc() {
		return MainControl.getVeiculoDocumentoFc();
	}

	public DocumentoFp getDocumentoFp() {
		return MainControl.getVeiculoDocumentoFp();
	}

	public DocumentoPc getDocumentoPc() {
		return MainControl.getVeiculoDocumentoFc().getDocumentoPc();
	}

	public DocumentoPp getDocumentoPp() {
		return MainControl.getVeiculoDocumentoFp().getDocumentoPp();
	}
