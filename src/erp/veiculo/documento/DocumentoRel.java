		...
		try {
			...
			for (Documento documento : documentos) {
				...
				document.add(new Paragraph(
						"NOME DO PROPRIETÁRIO DO VEÍCULO: " + documento.getVeiculo().getProprietarioNome()));
				...
				document.add(new Paragraph("------------------------------"));
				document.add(new Paragraph(
						"ANO DE RECEBIMENTO DO DOCUMENTO (CRV E CRLV): " + documento.getAnoRecebimentoDocumento()));
				document.add(new Paragraph(
						"MÊS DE RECEBIMENTO DO DOCUMENTO (CRV E CRLV): " + documento.getMesRecebimentoDocumento()));
				document.add(new Paragraph(
						"DIA DE RECEBIMENTO DO DOCUMENTO (CRV E CRLV): " + documento.getDiaRecebimentoDocumento()));
				document.add(new Paragraph("------------------------------"));
				document.add(new Paragraph(
						"ANO DE DEVOLUÇÃO DO DOCUMENTO (CRV E CRLV): " + documento.getAnoDevolucaoDocumento()));
				document.add(new Paragraph(
						"MÊS DE DEVOLUÇÃO DO DOCUMENTO (CRV E CRLV): " + documento.getMesDevolucaoDocumento()));
				document.add(new Paragraph(
						"DIA DE DEVOLUÇÃO DO DOCUMENTO (CRV E CRLV): " + documento.getDiaDevolucaoDocumento()));
				document.add(new Paragraph("------------------------------"));
				document.add(new Paragraph(
						"NOME DO RECEBEDOR DO DOCUMENTO (CRV E CRLV): " + documento.getNomeRecebedorDocumento()));
				...
				document.add(new Paragraph(
						"CNPJ DO RECEBEDOR DO DOCUMENTO (CRV E CRLV): " + documento.getCnpjRecebedorDocumento()));
				document.add(new Paragraph(
						"CPF DO RECEBEDOR DO DOCUMENTO (CRV E CRLV): " + documento.getCpfRecebedorDocumento()));
				document.add(
						new Paragraph("DOCUMENTO ESTÁ EM POSSE COM (CRV E CRLV): " + documento.getLocalDocumento()));
				document.add(new Paragraph("------------------------------"));
				document.add(new Paragraph(
