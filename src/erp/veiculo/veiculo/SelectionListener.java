		...
		if (!e.getValueIsAdjusting()) {
			...
			if (selRows.length > 0) {
				...
				if (table.getSelectedRow() != -1) {
					...
					MainGerenteEventos.getFrameCadastroVeiculo().getVeiculoHandle().setVeiculo(veiculo);
					MainGerenteEventos.getFrameCadastroVeiculo().getVeiculoHandle().atualizarGui();
