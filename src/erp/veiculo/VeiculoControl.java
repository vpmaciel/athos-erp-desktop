...
final class VeiculoControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getVeiculoFp());
		...
		public void actionPerformed(ActionEvent actionEvent) {
			try {
				...
				if (mensagem == JOptionPane.YES_OPTION) {
					...
					veiculo = new Veiculo();
					MainControl.getVeiculoFc().limparGui();
					getVeiculoPc().getGuiPlaca().requestFocus();
	...
	public void atualizarGui() {
		...
		getVeiculoPc().getGuiBairro().setText(veiculo.getEnderecoBairro());
		getVeiculoPc().getGuiCapCarga().setText(veiculo.getCapCarga());
		getVeiculoPc().getGuiCapaenderecoCidadePassageiros().setText(veiculo.getCapaenderecoCidadePassageiros());
		...
		getVeiculoPc().getGuiCep().setText(veiculo.getEnderecoCep());
		...
		getVeiculoPc().getGuiComplemento().setText(veiculo.getEnderecoComplemento());
		...
		getVeiculoPc().getGuiEstado().setText(veiculo.getEnderecoEstado());
		getVeiculoPc().getGuiLogradouro().setText(veiculo.getEnderecoLogradouro());
		...
		getVeiculoPc().getGuiCidade().setText(veiculo.getEnderecoCidade());
	...
	public void atualizarObjeto() {
		...
		veiculo.setEnderecoBairro(getVeiculoPc().getGuiBairro().getText());
		veiculo.setCapCarga(getVeiculoPc().getGuiCapCarga().getText());
		veiculo.setCapaenderecoCidadePassageiros(getVeiculoPc().getGuiCapaenderecoCidadePassageiros().getText());
		...
		veiculo.setEnderecoCep(getVeiculoPc().getGuiCep().getText());
		...
		veiculo.setEnderecoCidade(getVeiculoPc().getGuiCidade().getText());
		...
		veiculo.setEnderecoComplemento(getVeiculoPc().getGuiComplemento().getText());
		...
		veiculo.setEnderecoEstado(getVeiculoPc().getGuiEstado().getText());
		...
		veiculo.setEnderecoLogradouro(getVeiculoPc().getGuiLogradouro().getText());
	...
	public VeiculoFc getVeiculoFc() {
		return MainControl.getVeiculoFc();
	}

	public VeiculoFp getVeiculoFp() {
		return MainControl.getVeiculoFp();
	}

	public VeiculoPc getVeiculoPc() {
		return MainControl.getVeiculoFc().getVeiculoPc();
	}

	public VeiculoPp getVeiculoPp() {
		return MainControl.getVeiculoFp().getVeiculoPp();
	}
