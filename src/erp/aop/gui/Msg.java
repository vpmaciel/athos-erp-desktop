...
public final class Msg {
	...
	public static final void avisoCampoDuplicado(String campo, String valor) {
		JOptionPane.showMessageDialog(null,
				campo + " : " + valor + "\nVerifique se o campo acima já está cadastrado em outro registro !", "Informação",
				JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public static final void avisoFecharSistema() {
		JOptionPane.showMessageDialog(MainGerenteEventos.getFrameLogin().getPanelLogin(), "O sistema será fechado !", "Erro",
	...
	public static final int confirmarFecharJanela() {
		return JOptionPane.showOptionDialog(null, "Deseja fechar a janela ?", "Informação", JOptionPane.INFORMATION_MESSAGE,
				JOptionPane.YES_NO_OPTION, null, botoesSimNao, botoesSimNao[JOptionPane.INFORMATION_MESSAGE]);
	}
