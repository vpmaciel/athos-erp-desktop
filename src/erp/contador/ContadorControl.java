...
final class ContadorControl {
	...
	public class FechaJanela implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			try {
				MainControl.getContadorFc().setVisible(false);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public class MostraFrameContador extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent event) {
			if (event.getButton() == MouseEvent.BUTTON1) {
				...
				MainControl.getContadorFc().reiniciarGui();
			}
		}
	}
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getContadorFp());
	...
	public ContadorFc getContadorFc() {
		return MainControl.getContadorFc();
	}

	public ContadorFp getContadorFp() {
		return MainControl.getContadorFp();
	}

	public ContadorPc getContadorPc() {
		return MainControl.getContadorFc().getContadorPc();
	}

	public ContadorPp getContadorPp() {
		return MainControl.getContadorFp().getContadorPp();
	}
