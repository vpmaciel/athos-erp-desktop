...
final class IdiomaCont {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			totalPesquisaRegistro = getIdiomaPp().pesquisarRegistroCaracteristica(idioma);
			Msg.avisoRegistroEncontrado(totalPesquisaRegistro);

			if (totalPesquisaRegistro > 0) {
				MainCont.mostrarFrame(getIdiomaFp());
	...
	public IdiomaFc getIdiomaFc() {
		return MainCont.getCurriculoIdiomaFc();
	}

	public IdiomaFp getIdiomaFp() {
		return MainCont.getCurriculoIdiomaFp();
	}

	public IdiomaPc getIdiomaPc() {
		return MainCont.getCurriculoIdiomaFc().getIdiomaPc();
	}

	public IdiomaPp getIdiomaPp() {
		return MainCont.getCurriculoIdiomaFp().getIdiomaPp();
	}
