...
final class ObjetivoProfissionalControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getObjetivoProfissionalFp());
	...
	public ObjetivoProfissionalFc getObjetivoProfissionalFc() {
		return MainControl.getCurriculoObjetivoProfissionalFc();
	}

	public ObjetivoProfissionalFp getObjetivoProfissionalFp() {
		return MainControl.getCurriculoObjetivoProfissionalFp();
	}

	public ObjetivoProfissionalPc getObjetivoProfissionalPc() {
		return MainControl.getCurriculoObjetivoProfissionalFc().getObjetivoProfissionalPc();
	}

	public ObjetivoProfissionalPp getObjetivoProfissionalPp() {
		return MainControl.getCurriculoObjetivoProfissionalFp().getObjetivoProfissionalPp();
	}
