...
final class ExperienciaProfissionalControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getExperienciaProfissionalFp());
	...
	public ExperienciaProfissionalFc getExperienciaProfissionalFc() {
		return MainControl.getCurriculoExperienciaProfissionalFc();
	}

	public ExperienciaProfissionalFp getExperienciaProfissionalFp() {
		return MainControl.getCurriculoExperienciaProfissionalFp();
	}

	public ExperienciaProfissionalPc getExperienciaProfissionalPc() {
		return MainControl.getCurriculoExperienciaProfissionalFc().getExperienciaProfissionalPc();
	}

	public ExperienciaProfissionalPp getExperienciaProfissionalPp() {
		return MainControl.getCurriculoExperienciaProfissionalFp().getExperienciaProfissionalPp();
	}
