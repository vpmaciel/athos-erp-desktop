...
final class HabilidadeControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getHabilidadeFp());
	...
	public HabilidadeFc getHabilidadeFc() {
		return MainControl.getCurriculoHabilidadeFc();
	}

	public HabilidadeFp getHabilidadeFp() {
		return MainControl.getCurriculoHabilidadeFp();
	}

	public HabilidadePc getHabilidadePc() {
		return MainControl.getCurriculoHabilidadeFc().getHabilidadePc();
	}

	public HabilidadePp getHabilidadePp() {
		return MainControl.getCurriculoHabilidadeFp().getHabilidadePp();
	}
