...
final class TesteAvalPrefCerCont {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainCont.mostrarFrame(getTesteAvalPrefCerFp());
	...
	public TesteAvalPrefCerFc getTesteAvalPrefCerFc() {
		return MainCont.getCurriculoTesteAvalPrefCerFc();
	}

	public TesteAvalPrefCerFp getTesteAvalPrefCerFp() {
		return MainCont.getCurriculoTesteAvalPrefCerFp();
	}

	public TesteAvalPrefCerPc getTesteAvalPrefCerPc() {
		return MainCont.getCurriculoTesteAvalPrefCerFc().getTesteAvalPrefCerPc();
	}

	public TesteAvalPrefCerPp getTesteAvalPrefCerPp() {
		return MainCont.getCurriculoTesteAvalPrefCerFp().getCertificadoPp();
	}
