...
final class TesteDISCControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getTesteDISCFp());
	...
	public TesteDISCFc getTesteDISCFc() {
		return MainControl.getCurriculoTesteDISCFc();
	}

	public TesteDISCFp getTesteDISCFp() {
		return MainControl.getCurriculoTesteDISCFp();
	}

	public TesteDISCPc getTesteDISCPc() {
		return MainControl.getCurriculoTesteDISCFc().getTesteDISCPc();
	}

	public TesteDISCPp getTesteDISCPp() {
		return MainControl.getCurriculoTesteDISCFp().getCertificadoPp();
	}
