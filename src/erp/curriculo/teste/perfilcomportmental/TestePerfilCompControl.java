...
final class TestePerfilCompControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getTestePerfilCompFp());
	...
	public TestePerfilCompFc getTestePerfilCompFc() {
		return MainControl.getCurriculoTestePerfilCompFc();
	}

	public TestePerfilCompFp getTestePerfilCompFp() {
		return MainControl.getCurriculoTestePerfilCompFp();
	}

	public TestePerfilCompPc getTestePerfilCompPc() {
		return MainControl.getCurriculoTestePerfilCompFc().getTestePerfilCompPc();
	}

	public TestePerfilCompPp getTestePerfilCompPp() {
		return MainControl.getCurriculoTestePerfilCompFp().getCertificadoPp();
	}
