...
public final class PanelCadastroSindicato extends JPanel implements Gui {
	...
	public JComboBox<String> getBoxTipoSindicato() {
	...
	public void iniciarGui() {
		...
		textFieldNumeroFuncionarios.setDocument(new TamanhoUpperCase(5));
