...
final class SindicatoControl {
	...
	public class MostraFrameSindicato extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent event) {
			if (event.getButton() == MouseEvent.BUTTON1) {
				...
				MainControl.getSindicatoFc().reiniciarGui();
			}
		}
	}
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getSindicatoFp());
	...
	public SindicatoFc getSindicatoFc() {
		return MainControl.getSindicatoFc();
	}

	public SindicatoFp getSindicatoFp() {
		return MainControl.getSindicatoFp();
	}

	public SindicatoPc getSindicatoPc() {
		return MainControl.getSindicatoFc().getSindicatoPc();
	}

	public SindicatoPp getSindicatoPp() {
		return MainControl.getSindicatoFp().getSindicatoPp();
	}
