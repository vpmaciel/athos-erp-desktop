...
public final class PPCentroCusto extends JPanel {
	...
	public PPCentroCusto() {
		...
		table = new JTable();
		table.setModel(centroCustoTableModel);
	...
	public void atualizarGui(List<CentroCusto> centroCustos) {
		centroCustoTableModel.setCentroCustoList(centroCustos);
		centroCustoTableModel.fireTableDataChanged();
	}

	public CentroCustoTableModel getCentroCustoTableModel() {
		return centroCustoTableModel;
	}
	...
	public int pesquisarRegistroCentroCusto(CentroCusto centroCusto) {
		centroCustos = new LinkedList<>();
		try {
			centroCustos = new LinkedList<>(CentroCustoDaoFacade.pesquisarRegistro(centroCusto));
		} catch (Exception e) {
