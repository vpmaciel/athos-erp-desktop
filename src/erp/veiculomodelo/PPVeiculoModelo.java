...
public final class PPVeiculoModelo extends JPanel {
	...
	public PPVeiculoModelo() {
		...
		table = new JTable();
		table.setModel(veiculoModeloTableModel);
	...
	public void atualizarGui(List<VeiculoModelo> veiculoModelos) {
		veiculoModeloTableModel.setVeiculoModeloList(veiculoModelos);
		veiculoModeloTableModel.fireTableDataChanged();
	}

	public VeiculoModeloTableModel getVeiculoTableModel() {
		return veiculoModeloTableModel;
	}
	...
	public int pesquisarRegistroVeiculoModelo(VeiculoModelo veiculoModelo) {
		veiculoList = new LinkedList<>();
		try {
			veiculoList = new LinkedList<>(VeiculoModeloDaoFacade.pesquisarRegistro(veiculoModelo));
		} catch (Exception e) {
