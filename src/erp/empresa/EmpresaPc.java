...
public final class EmpresaPc extends JPanel implements Gui {
	...
	public JComboBox<String> getEmpresaGui() {
	...
	public void iniciarGui() {
		...
		textFieldNumeroFuncionarios.setDocument(new EntradaMaiuscula(6));
