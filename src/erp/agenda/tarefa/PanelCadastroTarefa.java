...
public final class PanelCadastroTarefa extends JPanel implements Gui {
	...
	public void reiniciarBox() {
		...
		if (!MainGerenteEventos.getFrameCadastroTarefa().isShowing()
				&& MainGerenteEventos.getFrameCadastroTarefa().getTarefaHandle().getTarefa() != null) {
			empresa = MainGerenteEventos.getFrameCadastroTarefa().getTarefaHandle().getTarefa().getEmpresa();
