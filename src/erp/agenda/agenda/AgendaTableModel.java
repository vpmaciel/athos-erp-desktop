...
public class AgendaTableModel extends AbstractTableModel {
	...
	private List<Agenda> agendaList = new LinkedList<>();
	...
	public AgendaTableModel(List<Agenda> lista) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Agenda agenda = agendaList.get(rowIndex);
		switch (columnIndex) {
		case COL_BAIRRO:
	...
	public void setAgendaList(List<Agenda> banco) {
		agendaList = banco;
	}
