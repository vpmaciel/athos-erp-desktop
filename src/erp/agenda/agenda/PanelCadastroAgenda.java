...
public final class PanelCadastroAgenda extends JPanel implements Gui {
	...
	public void reiniciarBox() {
		...
		if (!MainGerenteEventos.getFrameCadastroAgenda().isShowing()
				&& MainGerenteEventos.getFrameCadastroAgenda().getAgendaHandle().getAgenda() != null) {
			empresa = MainGerenteEventos.getFrameCadastroAgenda().getAgendaHandle().getAgenda().getEmpresa();
