...
final class RecadoControl {
	...
	public class Pesquisa implements ActionListener {
		...
		public void actionPerformed(ActionEvent actionEvent) {
			...
			if (totalPesquisaRegistro > 0) {
				MainControl.mostrarFrame(getRecadoFp());
		...
		public void actionPerformed(ActionEvent actionEvent) {
			try {
				...
				if (mensagem == JOptionPane.YES_OPTION) {
					...
					recado = new Recado();
					MainControl.getAgendaRecadoFc().limparGui();
					getRecadoPc().getGuiData().requestFocus();
	...
	public RecadoFc getRecadoFc() {
		return MainControl.getAgendaRecadoFc();
	}

	public RecadoFp getRecadoFp() {
		return MainControl.getAgendaRecadoFp();
	}

	public RecadoPc getRecadoPc() {
		return MainControl.getAgendaRecadoFc().getRecadoPc();
	}

	public RecadoPp getRecadoPp() {
		return MainControl.getAgendaRecadoFp().getRecadoPp();
	}
